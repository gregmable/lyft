...
class UberClient:
    ...
    def _detect_blocking_reason(self, page) -> str | None:
        ...
        if "sign in" in blob and "price estimate" in blob:
            return "Uber sign-in gate detected"
        if "captcha" in blob or "not a robot" in blob or "verify you are human" in blob:
            return "Uber anti-bot challenge detected"
        if "access denied" in blob or "temporarily unavailable" in blob:
            return "Uber page access blocked"
        return None
                ...
                with sync_playwright() as playwright:
                    ...
                    from_ok = self._fill_first_available(
                        ...
                        [
                            ...
                            "input[aria-label*='pickup location' i]",
                            "input[name*='pickup' i]",
                    ...
                    to_ok = self._fill_first_available(
                        ...
                        [
                            ...
                            "input[aria-label*='dropoff location' i]",
